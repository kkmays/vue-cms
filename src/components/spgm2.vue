<template>
  <div class="spgm-container">
    ...
    <div class="mui-card">
      <div class="mui-card-header">华为手机P30</div>
      <div class="mui-card-content">
        <div class="mui-card-content-inner">
          <p class="price">
            市场价:
            <del>￥4500</del>&nbsp; &nbsp;销售价:<span class="new_price">￥4000</span>
          </p>
          <p>购买数量：
...
<script>
  import jpg2 from '../lib/images/2.jpg'
  ...
  export default {
    ...
    methods: {
      ...
      addCard() {
        this.bollFalg = true;
        let goodInfo = {id: '1002', count: this.numValue, price: 4000, selected: true, title: '华为P30', url: jpg2};
